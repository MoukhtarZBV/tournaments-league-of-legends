...
public class TestParticiper {
	...
	public static void main(String[] args) throws Exception {
		...
		Joueur j1 = new Joueur(155, "Zeus", e1);
		Joueur j2 = new Joueur(255, "Oner", e1);
		Joueur j3 = new Joueur(355, "Faker", e1);
		Joueur j4 = new Joueur(455, "Gumayusi", e1);
		Joueur j5 = new Joueur(555, "Keria", e1);
